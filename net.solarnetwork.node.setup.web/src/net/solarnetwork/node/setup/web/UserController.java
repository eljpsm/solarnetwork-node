...
public class UserController extends BaseSetupWebServiceController {
	...
	public Response<Object> changePassword(UserProfile userProfile) {
		userService.changePassword(requireNonNullArgument(userProfile.getOldPassword(), "oldPassword"),
				requireNonNullArgument(userProfile.getPassword(), "password"),
				requireNonNullArgument(userProfile.getPasswordAgain(), "passwordAgain"));
