...
public class MethodAndIgnoreRequestMatcher implements RequestMatcher {
	...
	public static final Set<String> DEFAULT_ALLOWED_METHODS = Set.of("GET", "HEAD", "TRACE", "OPTIONS");

	private final Set<String> allowedMethods;
	private final @Nullable RequestMatcher ignoreMatcher;
	 ...
	 */
	public MethodAndIgnoreRequestMatcher(@Nullable RequestMatcher ignoreMatcher) {
	 ...
	 */
	public MethodAndIgnoreRequestMatcher(Set<String> allowedMethods,
			@Nullable RequestMatcher ignoreMatcher) {
		super();
		this.allowedMethods = requireNonNullArgument(allowedMethods, "allowedMethods");
